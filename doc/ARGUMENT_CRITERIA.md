...
- **Pro Kriterium** kann der Gutachter ein leichtes Flag **ok / beanstandet** setzen (kein 1–5-Rating) — als strukturiertes Signal, nicht als Stimmenzählung. **Optional**: Standard ist *nichts gewählt* (Toggle, erneuter Klick deselektiert); nur bewusst gesetzte Kriterien werden mitgeschickt (leere Liste ist gültig, das Backend akzeptiert sie — verbindlich bleibt nur das Gesamturteil).
...
- **Freier Text:** Pflicht bei „nein", optional bei „ja"; jederzeit nutzbar (z.B. „doppelt zu …").
