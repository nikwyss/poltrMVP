...
"[project]/src/components/position-band.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        lean == null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
var _c;
__turbopack_context__.k.register(_c, "PositionBand");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/topic-panorama.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
// Grayscale-Rampe je Thema: abwechselnd hell/dunkel für maximalen Kontrast
// benachbarter Ketten; Mitteltöne, die auf hellem wie dunklem Grund tragen.
// Unterscheidung sonst via Legende + Hover-Hervorhebung.
const PALETTE = [
    "#9a9a9a",
    "#cccccc",
    "#777777",
...
function buildChains(nodes, W, H, jitter, normalize, stacked) {
    ...
    const chains = sampled.map((s)=>{
        ...
        return {
            node: s.node,
            idx: s.idx,
            color: PALETTE[s.idx % PALETTE.length],
            contribs: s.contribs,
            mean: s.mean,
            d: "M" + pts.join(" L") + " Z",
            peakX: topX,
...
function buildStacked(prepared, W, H, jitter, normalize) {
    ...
    const chains = order.map((l)=>{
        ...
        return {
            node: l.node,
            idx: l.idx,
            color: PALETTE[l.idx % PALETTE.length],
            contribs: l.contribs,
            mean: l.mean,
            d: "M" + pts.join(" L") + " Z",
            peakX: topX,
...
function TopicPanorama({ nodes, t, argWidth = DEFAULT_W, argHeight = DEFAULT_H, ridgeJitter = DEFAULT_JITTER, normalizeArea = true }) {
    _s();
    const [stacked, setStacked] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const chains = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TopicPanorama.useMemo[chains]": ()=>buildChains(nodes, argWidth, argHeight, ridgeJitter, normalizeArea, stacked)
    }["TopicPanorama.useMemo[chains]"], [
        nodes,
        argWidth,
        argHeight,
        ridgeJitter,
    ...
    if (!nodes.length) return null;
    // Überlagert: grössere Ketten nach hinten. Gestapelt: Reihenfolge beibehalten
    // (untere Kette zuerst), damit die Bänder lückenlos sitzen.
    const drawOrder = stacked ? chains : chains.slice().sort((a, b)=>b.contribs.length - a.contribs.length || a.idx - b.idx);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
            ...
            children: [
                ...
                chains.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                            ...
                            children: [
                                drawOrder.map((c)=>{
                                    ...
                                    const fillA = stacked ? faded ? 0.12 : active === c.idx ? 0.85 : 0.62 : faded ? 0.06 : active === c.idx ? 0.5 : 0.3;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                        d: c.d,
                                        fill: rgba(c.color, fillA),
                                        stroke: c.color,
                                        strokeOpacity: faded ? 0.18 : active === c.idx ? 1 : 0.85,
                                        strokeWidth: active === c.idx ? 1.8 : 1.2,
                                        strokeLinejoin: "round",
                                        style: {
                                            cursor: "pointer",
                                            transition: "fill .12s, stroke-opacity .12s"
                                        },
                                ...
                                chains.map((c)=>c.contribs.map((v, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                                            x1: xPx(v),
                                            y1: BASE_Y,
                                            x2: xPx(v),
                                            y2: BASE_Y - 6,
                                ...
                                chains.map((c)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("polyline", {
                                        points: `${c.peakX},${(c.peakY - 4).toFixed(1)} ${c.peakX},${(yTop + 6).toFixed(1)} ${c.slotX.toFixed(1)},${yTop.toFixed(1)}`,
                                        fill: "none",
                                ...
                                chains.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("circle", {
                                        cx: c.peakX,
                                        cy: c.peakY,
                                ...
                                chains.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("text", {
                                        x: c.slotX,
                                        textAnchor: "middle",
                                        fontSize: 12,
                                        ...
                                        onMouseEnter: ()=>setActive(c.idx),
                                        onMouseLeave: ()=>setActive(null),
                                        children: c.lines.map((ln, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tspan", {
                                                x: c.slotX,
...
_s(TopicPanorama, "iSJbWRrgz9rjlR6BjSbaBDfQuYM=");
_c = TopicPanorama;
const __TURBOPACK__default__export__ = TopicPanorama;
var _c;
__turbopack_context__.k.register(_c, "TopicPanorama");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s(TaxonomySunburst, "JFe+DKWoGxS7AJPVS5WMM8uxEtA=");
_c = TaxonomySunburst;
...
"[project]/src/components/taxonomy-icicle.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var _c;
__turbopack_context__.k.register(_c, "TaxonomyIcicle");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$position$2d$band$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/position-band.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$topic$2d$panorama$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/topic-panorama.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$taxonomy$2d$icicle$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/taxonomy-icicle.tsx [app-client] (ecmascript)");
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$locked$2d$section$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LockedSection"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$position$2d$band$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PositionBand"], {
                                nodes: root.children,
                                t: t
                            }, void 0, false, {
                                fileName: "[project]/src/app/(app)/ballot/[id]/arguments/taxonomy/page.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$topic$2d$panorama$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TopicPanorama"], {
                                nodes: root.children,
                                t: t
                            }, void 0, false, {
                                fileName: "[project]/src/app/(app)/ballot/[id]/arguments/taxonomy/page.tsx",
                            ...
                            fullTree?.tree && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$taxonomy$2d$icicle$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TaxonomyIcicle"], {
                                root: fullTree.tree,
                                t: t,
                                onSelect: openTopicDetail
                            }, void 0, false, {
...
//# sourceMappingURL=src_1a2c334d._.js.map