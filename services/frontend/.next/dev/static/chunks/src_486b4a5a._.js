    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const handleSessionExpired = {
                "AuthProvider.useEffect.handleSessionExpired": ()=>{
                    setUser(null);
                    localStorage.removeItem('poltr_user');
                }
            }["AuthProvider.useEffect.handleSessionExpired"];
            ...
            return ({
                "AuthProvider.useEffect": ()=>window.removeEventListener('poltr:session-expired', handleSessionExpired)
            })["AuthProvider.useEffect"];
        }
    }["AuthProvider.useEffect"], []);
    const login = (user)=>{
...
function QueryProvider({ children }) {
    ...
    const [client] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(makeQueryClient);
...
_s(QueryProvider, "ybctLzdCCa2bRW3/yokRLKxBUGs=");
_c = QueryProvider;
var _c;
...
function joinURIBaseAndPath(base, path) {
...
async function readAllStreamWithLimit(stream, limit) {
...
//# sourceMappingURL=src_486b4a5a._.js.map